...
Innerhalb des nächsten Jahres sollen Schüler/innen von Leipziger Schulen  für Zukunftsthemen im außerunterrichtlichen Bereich sensibilisiert werden. Vorbild ist dabei das Trierer Zukunftsdiplom. Dabei sollen interessierte Schüler/innen einen Zukunftspass erhalten und auf diesem befindet sich eine ID zur Identifizierung. \newline %Letzter Satz komisch formuliert_Christopher
Diese Ausweise können vom Veranstalter über eine mobile App gescannt werden und damit kann erfasst werden welcher Schüler an wie vielen Veranstaltungen teilgenommen hat. %Das sollen sie können und können sie noch nicht, oder?_Christopher
...
Im Rahmen des Projektes soll eine App entwickelt werden über der sich die Schüler durch Eingabe oder Scannen ihrer IDs anschauen können an wie vielen Events sie teilgenommen haben und wenn möglich auch eine Liste von weiteren Events haben.\newline %"wenn möglich" finde ich hier unpassend, da das eines der Muss-Ziele ist_Christopher
