...
\item[SF040] Ein Schüler erhält pro besuchte Veranstaltung einen Punkt (nach scannen seiner ID). Diese werden fortlaufend aufsummiert und bilden seinen Highscore.
\end{itemize}
...
\item[EF150] Die Punkte die ein Schüler für eine besuchte Veranstaltung erhält werden nach (Zeit-)Aufwand gewichtet.
\end{itemize}
\subsubsection*{Funktionen für angemeldete Schüler}
\begin{itemize}
